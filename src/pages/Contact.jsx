    ...
    <div>
      ...
      <Section background="white">
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-lg md:text-xl text-gray-600">We'd love to hear from you. Send us a message and we'll respond as soon as possible.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          >
            <Card className="text-center h-full">
              ...
              <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-3">Phone</h3>
          ...
          >
            <Card className="text-center h-full">
              ...
              <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-3">Email</h3>
              <p className="text-gray-600 break-all">{content.contactInfo.email}</p>
          ...
          >
            <Card className="text-center h-full">
              ...
              <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-3">Address</h3>
          ...
          >
            <Card className="text-center h-full">
              ...
              <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-3">Office Hours</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          ...
          >
            <Card className="h-full">
              <h3 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6">Find Us Here</h3>
              <div className="relative h-64 md:h-96 bg-gray-200 rounded-lg overflow-hidden">
                ...
                <div className="absolute inset-0 bg-green-500 bg-opacity-20 flex items-center justify-center">
                  <div className="bg-white p-4 rounded-lg shadow-lg text-center">
                    ...
                    <p className="text-sm font-semibold text-gray-800">QB365 Public School</p>
                    <p className="text-xs text-gray-600">Nature Park, Cityname</p>
                  </div>
                </div>
              </div>
      ...
      <Section background="white">
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-lg md:text-xl text-gray-600">Quick answers to common questions</p>
        </div>
            ...
            {[
              {
                ...
                answer: "School timings are from 8:00 AM to 2:30 PM for all classes. Extended care is available until 5:00 PM."
              },
              {
                question: "Is transportation facility available?",
                answer: "Yes, we provide safe and reliable bus transportation covering various routes across the city with GPS tracking."
              },
              {
                question: "What is the admission process?",
                answer: "The admission process includes application submission, document verification, entrance assessment, parent interview, and final confirmation."
              },
              {
                question: "Are there any scholarship programs?",
                answer: "Yes, we offer merit-based scholarships and need-based financial assistance for deserving students."
              },
              {
                question: "What extracurricular activities are offered?",
                answer: "We offer a wide range of activities including sports, music, dance, art, drama, science club, and environmental club."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
