...
import { Monitor, Microscope, BookOpen, Trophy, Bus, Wifi, Shield, Zap } from 'lucide-react';
...
const Infrastructure = () => {
  ...
  const techFeatures = [
    { icon: Wifi, title: 'High-Speed Internet', description: 'Campus-wide WiFi connectivity' },
    { icon: Monitor, title: 'Digital Learning', description: 'Smart boards in every classroom' },
    { icon: Shield, title: 'Security Systems', description: 'CCTV monitoring and access control' },
    ...
    <div>
      ...
      <Section background="white">
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Our Campus</h2>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
            Spread across 10 acres of lush green campus, our infrastructure combines modern technology with nature-friendly design to create an ideal learning environment.
          </p>
        </div>
      ...
      <Section background="gray">
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-lg md:text-xl text-gray-600">State-of-the-art facilities designed for comprehensive education</p>
        </div>
              ...
              <Card>
                <div className={`grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-center ${
                  ...
                  <div className={index % 2 === 1 ? 'lg:col-start-1' : ''}>
                    <h3 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">{facility.title}</h3>
      ...
      <Section background="white">
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Safety & Security</h2>
          <p className="text-lg md:text-xl text-gray-600">Your child's safety is our top priority</p>
        </div>
          ...
          {[
            ...
            >
              <Card className="text-center h-full">
                ...
                <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-3">{safety.title}</h3>
                <p className="text-sm md:text-base text-gray-600">{safety.description}</p>
              </Card>
            </motion.div>
          ))}
        </div>
      ...
      <Section background="green">
        <div className="text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Experience Our Campus</h2>
