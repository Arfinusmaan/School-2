...
const defaultContent = {
  ...
  vision: "To be a leading educational institution that nurtures environmentally conscious global citizens who excel academically and contribute positively to society.",
  mission: "Our mission is to provide quality education that combines academic excellence with environmental awareness, fostering critical thinking, creativity, and moral values in our students while preparing them for future challenges.",
  principalMessage: "Welcome to QB365 Public School, where we nurture young minds to bloom like flowers in a garden. Our commitment to excellence in education, combined with our love for nature, creates an environment where students thrive academically, socially, and emotionally. We believe every child is unique and has the potential to achieve greatness.",
  ...
  contactInfo: {
    ...
    address: "123 Road, Nature Park, Cityname - 560001",
    website: "www.qb365.edu"
  },
  academics: {
    cbseAffiliation: "Affiliated to Central Board of Secondary Education, New Delhi",
    schoolCode: "12345",
    curriculum: [
      {
        subject: "Mathematics",
